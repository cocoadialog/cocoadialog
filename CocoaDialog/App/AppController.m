...
@implementation AppController @synthesize arguments, currentControl, aboutAppLink, aboutText, aboutPanel, options;
...
- (void) awakeFromNib {
  ...
  if ([NSProcessInfo.processInfo.arguments containsObject:@"modes"] )
    ...
    [NSFileHandle.fileHandleWithStandardOutput writeData:
      [[CDControl.availableControls.allKeys componentsJoinedByString:@"\n"]
  ...
  if ( [[runMode substringToIndex:4] isEqualToString:@"-psn"]
    ||  [runMode caseInsensitiveCompare:@"about"] == NSOrderedSame) {
