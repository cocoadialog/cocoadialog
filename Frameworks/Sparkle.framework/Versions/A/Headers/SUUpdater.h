...
@property (NS_NONATOMIC_IOSONLY, readonly, strong) NSBundle *hostBundle;

@property (NS_NONATOMIC_IOSONLY, assign) id delegate;

@property (NS_NONATOMIC_IOSONLY) BOOL automaticallyChecksForUpdates;

@property (NS_NONATOMIC_IOSONLY) NSTimeInterval updateCheckInterval;

@property (NS_NONATOMIC_IOSONLY, copy) NSURL *feedURL;	// *** MUST BE CALLED ON MAIN THREAD ***

@property (NS_NONATOMIC_IOSONLY, copy) NSString *userAgentString;

@property (NS_NONATOMIC_IOSONLY) BOOL sendsSystemProfile;

@property (NS_NONATOMIC_IOSONLY) BOOL automaticallyDownloadsUpdates;
...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSDate *lastUpdateCheckDate;
...
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL updateInProgress;
