...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    if (@available(macOS 10.9, *)) {
      [self.panel endSheet:self.confirmationSheet.window];
    }
    else {
...
#pragma ide diagnostic ignored "-Wdeprecated-declarations"
  if (@available(macOS 10.9, *)) {
    ...
    [self.confirmationSheet beginSheetModalForWindow:self.panel modalDelegate:nil didEndSelector:@selector(alertDidEnd:returnCode:contextInfo:) contextInfo:nil];
  }
#pragma clang diagnostic pop
}
