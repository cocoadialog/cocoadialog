...
- (NSString *)onBlack {
  self.color.bg = CDColorBgBlack;
  return self.formattedString;
}

- (NSString *)onRed {
  self.color.bg = CDColorBgRed;
  return self.formattedString;
}

- (NSString *)onGreen {
  self.color.bg = CDColorBgGreen;
  return self.formattedString;
}

- (NSString *)onYellow {
  self.color.bg = CDColorBgYellow;
  return self.formattedString;
}

- (NSString *)onBlue {
  self.color.bg = CDColorBgBlue;
  return self.formattedString;
}

- (NSString *)onMagenta {
  self.color.bg = CDColorBgMagenta;
  return self.formattedString;
}

- (NSString *)onCyan {
  self.color.bg = CDColorBgCyan;
  return self.formattedString;
}

- (NSString *)onWhite {
  self.color.bg = CDColorBgWhite;
  return self.formattedString;
}

- (NSString *)black {
  self.color.fg = CDColorFgBlack;
  return self.formattedString;
}

- (NSString *)red {
  self.color.fg = CDColorFgRed;
  return self.formattedString;
}

- (NSString *)green {
  self.color.fg = CDColorFgGreen;
  return self.formattedString;
}

- (NSString *)yellow {
  self.color.fg = CDColorFgYellow;
  return self.formattedString;
}

- (NSString *)blue {
  self.color.fg = CDColorFgBlue;
  return self.formattedString;
}

- (NSString *)magenta {
  self.color.fg = CDColorFgMagenta;
  return self.formattedString;
}

- (NSString *)cyan {
  self.color.fg = CDColorFgCyan;
  return self.formattedString;
}

- (NSString *)white {
  self.color.fg = CDColorFgWhite;
  return self.formattedString;
}

- (NSString *)lightBlack {
  self.color.fg = CDColorFgLightBlack;
  return self.formattedString;
}

- (NSString *)lightRed {
  self.color.fg = CDColorFgLightRed;
  return self.formattedString;
}

- (NSString *)lightGreen {
  self.color.fg = CDColorFgLightGreen;
  return self.formattedString;
}

- (NSString *)lightYellow {
  self.color.fg = CDColorFgLightYellow;
  return self.formattedString;
}

- (NSString *)lightBlue {
  self.color.fg = CDColorFgLightBlue;
  return self.formattedString;
}

- (NSString *)lightMagenta {
  self.color.fg = CDColorFgLightMagenta;
  return self.formattedString;
}

- (NSString *)lightCyan {
  self.color.fg = CDColorFgLightCyan;
  return self.formattedString;
}

- (NSString *)lightWhite {
  self.color.fg = CDColorFgLightWhite;
  return self.formattedString;
}

- (NSString *)bold {
  [self.color addStyle:CDColorStyleBold];
  return self.formattedString;
}

- (NSString *)dim {
  [self.color addStyle:CDColorStyleDim];
  return self.formattedString;
}

- (NSString *)italic {
  [self.color addStyle:CDColorStyleItalic];
  return self.formattedString;
}

- (NSString *)underline {
  [self.color addStyle:CDColorStyleUnderline];
  return self.formattedString;
}

- (NSString *)blink {
  [self.color addStyle:CDColorStyleBlink];
  return self.formattedString;
}

- (NSString *)swap {
  [self.color addStyle:CDColorStyleSwap];
  return self.formattedString;
}

- (NSString *)clearBg {
  self.color.bg = CDColorBgNone;
  return self.formattedString;
}

- (NSString *)clearFg {
  self.color.fg = CDColorFgNone;
  return self.formattedString;
}

- (NSString *)clearStyles {
  [self.color removeAllStyles];
  return self.formattedString;
}
...
- (NSMutableString *)formattedString {
  ...
  if (color.isApplied) {
    ...
    if (color.fg != CDColorFgNone) {
      [formattedString appendString:[NSString stringWithFormat:@"%li;", (long) color.fg]];
    }

    // Add background.
    if (color.bg != CDColorBgNone) {
      [formattedString appendString:[NSString stringWithFormat:@"%li;", (long) color.bg]];
    }

    // Append styles.
    for (unsigned int i = 0; i < color.styles.count; i++) {
      [formattedString appendString:[NSString stringWithFormat:@"%li;", (long) color.styles[i].intValue]];
    }
