...
- (NSString *) returnValueEmptyText {
  ...
  return self.checkboxes.count > 1 ? @"You must check at least one item before continuing." :
  [NSString stringWithFormat: @"You must check the item \"%@\" before continuing.", [self.checkboxes[0] title]];
}
